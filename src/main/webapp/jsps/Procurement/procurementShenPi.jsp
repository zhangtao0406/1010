...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div style="width: 900px; margin-top: 50px" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title" id="myModalLabel4">采购审批</h4>
            </div>
            <form  id="procurementShenPi" style="width:680px; margin-left: 110px">
                                    ...
                                    <div class="layui-col-md6">
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <div class="layui-input-inline">
                                                    <input class="layui-input" type="text" placeholder="审批人"
                                                           readonly="readonly"  id="approvalName4" name="approvalName"
                                                           autocomplete="off"/>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="layui-field-box">
                            <div class="layui-row">
                                    ...
                                    <div class="layui-col-md6">
                                        <div class="layui-inline">
                                            ...
                                            <div class="layui-input-inline">
                                                <div class="layui-input-inline">
                                                    <input class="layui-input" type="text" placeholder="审批人"
                                                           name="approvalName" readonly="readonly"  value="${userSession.userName }"
                                                           autocomplete="off"/>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="layui-row">
                                    <div class="layui-col-md12">
                                        <div class="layui-inline">
                                            <label class="layui-form-label" style="width: 100px">审批意见:</label>
                                            <div class="layui-input-inline">
                                                    <textarea style="width: 515px" id="approvalOpinion4" name="approvalOpinion" required  placeholder="请您填写审批意见"
            ...
            <div class="modal-footer">
                <button type="button" onclick="procurementBuTongGuo()" class="btn btn-danger">审批不通过</button>
                <button type="button" onclick="procurementTongGuo()" class="btn btn-primary">审批通过返回申请人</button>
                <button type="button"  class="btn btn-default" data-dismiss="modal">关闭</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
...
<script type="text/javascript">
    ...
    function ProcurementLike() {
        $.ajax({
            ...
            url: "${pageContext.request.contextPath}/ProcurementController/findProcurementShenPiAll",
            dataType: "json",
                    ...
                    formatter: function (value, row, index) {
                       if (row.procurementStatus == 1) {
                            return "<a class='btn btn-info' onclick='ProcurementAllByIdMyModal(" + row.id + ")' role='button' >查看采购</a>&nbsp;" +
                                    "<a class='btn btn-success' onclick='ProcurementShenPiMyModal(" + row.id + ")' role='button' >采购审批</a>";
    ...
    /*------------------采购申请管理采购审批------------------ --------------------分割线-------------------开始------------------------------*/
    //采购申请管理采购审批
    function ProcurementShenPiMyModal(id) {
        document.getElementById("procurementShenPi").reset();
        $("#myModal4").modal("show")
    ...
    //审批不通过
    function procurementBuTongGuo() {
        var procurementId = $("#Procurementid").val();
        var approvalOpinion = $("#approvalOpinion4").val();
        if (window.confirm("是否对本次审批不通过?")) {
            $.ajax({
                type: "post",
                url: "${pageContext.request.contextPath}/ProcurementController/procurementBuTongGuo?procurementId=" + procurementId+"&approvalOpinion=" + approvalOpinion,
                dataType: "json",
                success: function (data) {
                    if (data > 0) {
                        alert("审批已经打回！！")
    ...
    //审批通过返回申请人
    function procurementTongGuo() {
        var procurementId = $("#Procurementid").val();
        var approvalOpinion = $("#approvalOpinion4").val();
        if (window.confirm("是否确认通过审批?")) {
            $.ajax({
                type: "post",
                url: "${pageContext.request.contextPath}/ProcurementController/procurementTongGuo?procurementId=" + procurementId+"&approvalOpinion=" + approvalOpinion,
                dataType: "json",
                success: function (data) {
                    if (data > 0) {
                        alert("审批以通过！！")
